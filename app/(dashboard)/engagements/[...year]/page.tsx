...
const EngagementsPage =  ({ params }: { params: { year: string } }) => {
 // const { onOpen } = useNewClient();
  const engagementsQuerry = useGetEngagements(params.year); 
        ...
        <div className="max-w-screen-2xl mx-auto w-full pb-10 -mt-24">
          <Card className=" border-none drop-shadow-sm">
            ...
            <CardContent> 
                ...
                <div>
                    <DataTable columns={columns} data={engagements} filterKey="email" />
                </div>             
            </CardContent>
          </Card>
        </div>     
