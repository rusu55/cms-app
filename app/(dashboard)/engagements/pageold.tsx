...
const EngagementsPage = ({
  ...
  let formatSearchParams: any = {};

  if (searchParams.get("key") !== null) {
    formatSearchParams["search"] = searchParams.get("key");
  }
  if (searchParams.get("year") !== null) {
    formatSearchParams["year"] = searchParams.get("year");
  }

  const engagementsQuerry = useGetEngagements(formatSearchParams);
